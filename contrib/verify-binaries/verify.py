...
signature file SHA256SUMS.asc from bitcoinIIcore.org and bitcoinII.org and
compares them.
...
HOST1 = "https://bitcoinIIcore.org"
HOST2 = "https://bitcoinII.org"
...
def verify_published_handler(args: argparse.Namespace) -> ReturnCode:
    ...
    # remove binaries that are known not to be hosted by bitcoinIIcore.org
...
def main():
    ...
    pub_parser.add_argument(
        ...
        help=(
            ...
            '(Sometimes bitcoinII.org lags behind bitcoinIIcore.org.)')
    )
