...
```
$ python3 contrib/tracing/p2p_monitor.py ./src/bitcoinIId
```
...
```
$ python3 contrib/tracing/log_raw_p2p_msgs.py ./src/bitcoinIId
```
...
```bash
$ python3 contrib/tracing/log_utxocache_flush.py ./src/bitcoinIId
```
...
```console
$ python3 contrib/tracing/mempool_monitor.py ./src/bitcoinIId
```
