...
```sh
# Get block count from the / endpoint when rpcuser=alice and rpcport=38342
$ curl --user alice --data-binary '{"jsonrpc": "1.0", "id": "0", "method": "getblockcount", "params": []}' -H 'content-type: text/plain;' localhost:38342/

# Get balance from the /wallet/walletname endpoint when rpcuser=alice, rpcport=38342 and rpcwallet=desc-wallet
$ curl --user alice --data-binary '{"jsonrpc": "1.0", "id": "0", "method": "getbalance", "params": []}' -H 'content-type: text/plain;' localhost:38342/wallet/desc-wallet
