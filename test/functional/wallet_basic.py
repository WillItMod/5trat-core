...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if not self.options.descriptors:
            ...
            # BCH2: p2sh-segwit produces a P2PKH address, so the error is -4 (key not found)
        ...
        assert_equal(address_info['address'], "bitcoincashii:qp8rs4qyd3aazk22eyzwg7fmdfzmxm02pyz686sg9p")
