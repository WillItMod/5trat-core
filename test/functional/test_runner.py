...
BASE_SCRIPTS = [
    ...
    'wallet_migration.py',
    # 'p2p_ibd_txrelay.py',
    # BCH2-specific functional tests
    'feature_bch2_consensus.py',
    'feature_bch2_abla.py',
    'feature_bch2_tx_lifecycle.py --legacy-wallet',
    'feature_bch2_rbf_disabled.py --legacy-wallet',
    'feature_bch2_finalization.py',
    'feature_bch2_wallet_import.py --legacy-wallet',
    'feature_bch2_wallet_segwit.py --legacy-wallet',
    'feature_bch2_consensus_edge.py --legacy-wallet',
    'p2p_dsproof.py --legacy-wallet',
    'p2p_bch2_reorg.py',
    'p2p_bch2_adversarial.py',
    # Don't append tests at the end to avoid merge conflicts
    # Put them in a random line within the section that fits their approximate run-time
]

# SegWit/Taproot tests - BCH2 removed SegWit and Taproot
# RBF tests - BCH2 disabled Replace-By-Fee
BCH2_EXCLUDED_SEGWIT_RBF = [
    'feature_taproot.py',
    'p2p_segwit.py',
