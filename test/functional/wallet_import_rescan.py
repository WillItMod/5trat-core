...
class Variant(collections.namedtuple("Variant", "call data address_type rescan prune")):
    ...
    def do_import(self, timestamp):
        ...
        # BCH2: Only legacy (P2PKH) addresses exist - no SegWit
        ...
        if self.call == Call.single:
            ...
            # BCH2: No p2sh_segwit redeemscript handling needed (no SegWit)
...
# BCH2: Only legacy (P2PKH) address type - no SegWit (bech32, p2sh-segwit)
    ...
    def run_test(self):
        ...
        for variant in mempool_variants:
            ...
            child = self.nodes[1].send(
                ...
                outputs=[{ADDRESS_BCH2_UNSPENDABLE : variant.initial_amount}],
