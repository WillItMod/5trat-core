...
class NetTest(BitcoinTestFramework):
    ...
    def test_sendmsgtopeer(self):
        ...
        # BCH2: MAX_PROTOCOL_MESSAGE_LENGTH is 33MB, so sending >33MB via RPC
        # is impractical. Oversized message handling is tested in p2p_invalid_messages.py instead.
        self.log.debug("Skipping oversized message test (BCH2: 33MB limit tested in p2p_invalid_messages)")
