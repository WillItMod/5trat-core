...
class ImportMultiTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # BCH2: Skip P2WPKH, P2WSH, P2SH-P2WPKH, P2SH-P2WSH import tests.
        # These address types do not exist in BCH2 (no SegWit).
        self.log.info("Skipping SegWit address import tests (P2WPKH, P2WSH, P2SH-P2WPKH, P2SH-P2WSH) - not supported in BCH2")

        # BCH2: Use pkh() descriptor instead of sh(wpkh()) since SegWit is not supported
        ...
        self.test_importmulti({"desc": descsum_create(desc),
                               ...
                               "range": 1},
                              success=True)
        # BCH2: We verify addresses derived from this pkh descriptor are mine
        for i in range(2):
        ...
        # BCH2: Test importing a descriptor containing a WIF private key using pkh() instead of sh(wpkh())
        ...
        # BCH2: Use pkh() descriptors instead of wpkh() since SegWit is not supported
        ...
        # BCH2: Use pkh() descriptors instead of wpkh()
        ...
        # BCH2: Use sh(multi()) instead of wsh(multi()) since SegWit is not supported
        ...
        # BCH2: Use pkh() descriptor instead of wpkh()
