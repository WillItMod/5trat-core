...
MAX_PROTOCOL_MESSAGE_LENGTH = 33 * 1000 * 1000  # Maximum length of incoming protocol messages (BCH2: 33MB for 32MB blocks)
...
class CTransaction:
    ...
    def __init__(self, tx=None):
        if tx is None:
            ...
            self._bch2_input_amounts = getattr(tx, '_bch2_input_amounts', None)
