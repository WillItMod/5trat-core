...
class MiniWalletMode(Enum):
    ...
    ECDSA signature. (BCH2: changed from P2TR/SegWit to P2PKH since SegWit is
...
class MiniWallet:
    ...
    def sign_tx(self, tx, fixed_length=True, input_amounts=None):
        if input_amounts is None:
            input_amounts = getattr(tx, '_bch2_input_amounts', None)
    ...
    def create_self_transfer_multi(
        ...
        *,
        ...
        tx._bch2_input_amounts = input_amounts  # Store for re-signing after modification
