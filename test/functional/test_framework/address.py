...
# BCH2 CashAddr encoding
CASHADDR_CHARSET = "qpzry9x8gf2tvdw0s3jn54khce6mua7l"
CASHADDR_PREFIX_MAINNET = "bitcoincashii"
CASHADDR_PREFIX_TESTNET = "bchiitest"
CASHADDR_PREFIX_REGTEST = "bitcoincashii"  # regtest uses same prefix
...
# BCH2: Unspendable P2PKH CashAddr address (hash160 = all zeros, no one has the private key)
ADDRESS_BCH2_UNSPENDABLE = cashaddr_encode(CASHADDR_PREFIX_REGTEST, 0, b'\x00' * 20)
