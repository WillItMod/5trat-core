...
class MiningTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("getblocktemplate: Verify no witness commitment (BCH2 has no SegWit)")
        txid = int(self.wallet.send_self_transfer(from_node=node)['wtxid'], 16)
        tmpl = node.getblocktemplate(NORMAL_GBT_REQUEST_PARAMS)

        # BCH2 does not have SegWit, so no witness commitment should be present
        ...
        self.log.info("getblocktemplate: BCH2 does not require segwit rule")
