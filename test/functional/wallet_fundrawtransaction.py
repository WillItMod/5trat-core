...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def lock_outputs_type(self, wallet, outputtype):
        ...
        # BCH2: Lock UTXOs that do NOT match the given type, so only the
    ...
    def test_invalid_change_address(self):
        ...
        assert_raises_rpc_error(-5, "Change address must be a valid BCH2 address", self.nodes[2].fundrawtransaction, rawtx, changeAddress='foobar')
    ...
    def test_locked_wallet(self):
        ...
        if self.options.descriptors:
            with WalletUnlock(wallet, "test"):
                # BCH2: Use pkh() descriptors instead of wpkh() (no SegWit)
        ...
        tx_size = 192  # BCH2: P2PKH -> P2PKH: 10 (overhead) + 148 (input) + 34 (output) = 192 bytes
    ...
    def test_option_feerate(self):
        ...
        # BCH2: P2PKH 1-in 2-out tx = 10 + 147 + 34*2 = 225 bytes. At ~1 sat/B, expect ~225 sat.
        ...
        assert_raises_rpc_error(-8, "Cannot specify both fee_rate (sat/vB) and feeRate (BCH2/kvB)",
    ...
    def test_external_inputs(self):
        ...
        # BCH2: WITNESS_SCALE_FACTOR=1 so min weight = 42 (41 bytes outpoint+sequence+empty scriptSig + 1 empty witness)
        ...
        # BCH2: WITNESS_SCALE_FACTOR=1, so weight = size; multiply by 1 instead of 4
        ...
        # BCH2: weight = vsize (no witness discount)
    ...
    def test_weight_calculation(self):
        ...
        # BCH2 P2PKH: with 71-byte signatures (wallet can grind R)
    ...
    def test_feerate_rounding(self):
        ...
        # BCH2: A P2PKH input costs 148 bytes; With a single P2PKH output (34 bytes) + overhead (10 bytes) = 192 bytes total.
