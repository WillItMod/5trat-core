...
class ListTransactionsTest(BitcoinTestFramework):
    ...
    def run_rbf_opt_in_test(self):
        ...
        self.log.info("Test txs with low nSequence (BCH2: no RBF, always bip125-replaceable=no)")
        # Tx3 has low nSequence (would be opt-in RBF in Bitcoin Core, but not in BCH2)
        ...
        # BCH2: No RBF support, bip125-replaceable is always "no"
        ...
        # BCH2: No RBF, so even children of opt-in parents are "no"
        ...
        # BCH2: Skip RBF replacement test (tx3_b) since BCH2 has no RBF
