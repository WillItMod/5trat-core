...
class WalletMigrationTest(BitcoinTestFramework):
    ...
    def test_basic(self):
        ...
        # BCH2: The wallet should create the following descriptors:
        ...
        # BCH2: No bech32/SegWit - test with legacy (P2PKH) address instead
        ...
        # BCH2: Only P2PKH addresses - no SegWit output types
        basic2_balance = 0
    ...
    def test_no_privkeys(self):
        ...
        # BCH2: Use legacy (P2PKH) addresses instead of bech32
    ...
    def run_test(self):
        ...
        # BCH2: test_conflict_txs requires RBF which BCH2 does not support
        # self.test_conflict_txs()
        self.test_hybrid_pubkey()
        self.test_failed_migration_cleanup()
        self.test_avoidreuse()
        # BCH2: test_preserve_tx_extra_info requires bumpfee/RBF which BCH2 does not support
