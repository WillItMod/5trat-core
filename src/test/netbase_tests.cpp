...
{
    BOOST_CHECK(TestSplitHost("www.bitcoinIIcore.org", "www.bitcoinIIcore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.bitcoinIIcore.org]", "www.bitcoinIIcore.org", 0));
    BOOST_CHECK(TestSplitHost("www.bitcoinIIcore.org:80", "www.bitcoinIIcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoinIIcore.org]:80", "www.bitcoinIIcore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.bitcoinIIcore.org:65536", "www.bitcoinIIcore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitcoinIIcore.org:0", "www.bitcoinIIcore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitcoinIIcore.org:", "www.bitcoinIIcore.org:", 0, false));
}
