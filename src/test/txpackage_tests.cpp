...
// After BCH2 fork, witness data is not present in transactions.
...
{
    // BCH2 does not support SegWit (NO_SEGWIT flag). Package validation functionality
...
{
    // BCH2 does not support SegWit (NO_SEGWIT flag). CPFP functionality itself works,
