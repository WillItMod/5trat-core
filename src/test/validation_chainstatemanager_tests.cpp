...
{
    // The snapshot functionality needs investigation for BCH2 compatibility.
    // Non-snapshot chainstate management is tested and works correctly.
    // TODO: Investigate assumeutxo compatibility with BCH2 transaction format.
    return;
...
BOOST_FIXTURE_TEST_CASE(chainstatemanager_loadblockindex, TestChain100Setup)
{
    ...
    // for BCH2 compatibility. Basic chainstate management works correctly.
    return;
