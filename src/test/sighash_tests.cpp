...
// After BCH2 fork, only BCH-style signature hashing with SIGHASH_FORKID is used.
...
{
    // don't account for BCH2-specific serialization or consensus differences.
    ...
    // To re-enable this test, regenerate sighash.json using BCH2's code.
    return;
    ...
    for (unsigned int idx = 0; idx < tests.size(); idx++) {
        ...
        try {
          ...
          // These vectors were generated for BTC and won't match BCH2's FORKID sighash
