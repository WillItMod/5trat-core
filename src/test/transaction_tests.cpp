...
// After BCH2 fork, new transactions do not include witness data.
...
// Excludes BCH2-specific flags that would break legacy test compatibility
unsigned int GetAllKnownFlags()
{
    ...
    // Exclude BCH2-specific flags from the "all known" mask
...
// This prevents BCH2-specific flags from being accidentally enabled
...
BOOST_AUTO_TEST_CASE(test_IsStandard)
{
    ...
    // BCH2: MAX_OP_RETURN_RELAY=223, so 220 bytes of data + OP_RETURN + OP_PUSHDATA1 + len = 223
