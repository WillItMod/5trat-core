        ...
        },
        {
            ...
            RPCResult{"Otherwise", RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::OBJ, "5trat", "5tratum Coin proof-quality metadata",
                {
                    ...
                    {RPCResult::Type::STR_HEX, "gold_target", "twelve-times-stronger achievement target"},
                }},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    tier_metadata.pushKV("gold_target", GetProofTierTarget(pblock->nBits, ProofTier::GOLD).GetHex());
    result.pushKV("5trat", tier_metadata);
