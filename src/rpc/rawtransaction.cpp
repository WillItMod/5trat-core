...
// After BCH2 fork, transactions have no witness data; hash equals txid, vsize equals size.
...
static std::vector<RPCArg> CreateTxDoc()
{
    return {
        ...
        {"replaceable", RPCArg::Type::BOOL, RPCArg::Default{false}, "Marks this transaction as BIP125-replaceable.\n"
                "Note: RBF is not supported on BCH2 after the fork. This parameter controls sequence number selection only.\n"
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (can_wrap) {
        ...
        // After BCH2 fork, SegWit transactions are not valid on-chain.
        if (can_wrap_P2WSH) {
