...
UniValue blockheaderToJSON(const CBlockIndex& tip, const CBlockIndex& blockindex)
{
    ...
    result.pushKV("tier", ProofTierName(ClassifyProofTier(blockindex.GetBlockHash(), blockindex.nBits)));
                ...
                },
                {
                    RPCResult{"for verbose = true",
                        RPCResult::Type::OBJ, "", "",
                        {
                            ...
                            {RPCResult::Type::STR, "tier", "5TRAT proof-quality achievement: blue, pink or gold"},
