...
enum BlockStatus : uint32_t {
    ...
    /**
     * BCH2/BCHN: Block has been parked (temporarily rejected).
    ...
    /**
     * BCH2/BCHN: Descends from a parked block.
     */
...
public:
    ...
    //! BCH2/BCHN: @returns true if the block is parked (temporarily rejected).
