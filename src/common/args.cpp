...
const char * const BITCOINII_CONF_FILENAME = "fivetrat.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "5tratum Coin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/5tratum Coin";
#else
    // Unix-like
    return pathRet / ".fivetrat";
#endif
#endif
}
