...
protected:
    ...
    //! BCH2/BCHN: Height of the most recently finalized block (rolling checkpoint).
...
public:
    ...
    // =========================================================================
    // BCH2/BCHN Automatic Finalization (Rolling Checkpoints)
    // =========================================================================

    /** BCH2/BCHN: Park a block (temporarily reject it).
    ...
    /** BCH2/BCHN: Get the current finalized block height.
    ...
    /** BCH2/BCHN: Check if a reorg would cross the finalization boundary.
     *  Returns true if the reorg should be rejected.
     */
    bool WouldCrossFinalization(const CBlockIndex* pindexFork) const
        EXCLUSIVE_LOCKS_REQUIRED(cs_main);

    /** BCH2/BCHN: Update automatic finalization after connecting a new block.
