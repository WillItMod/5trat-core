...
public:
     ...
     *  + non-input fees always include segwit flags (BCH2: not applicable after fork - no witness data)
     *  + input fee estimation always include segwit stack size (BCH2: not applicable after fork)
