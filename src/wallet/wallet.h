...
//! -fallbackfee default (BCH2: Match BCHN - 20 sat/byte)
...
//! -walletrbf default (BCH2: RBF disabled, no opt-in RBF support)
...
// With WITNESS_SCALE_FACTOR=1 (BCH2), no witness discount: P2SH-P2WPKH input vsize = 172
