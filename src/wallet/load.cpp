...
bool LoadWallets(WalletContext& context)
{
    ...
    try {
        ...
        LogPrintf("BCH2 MIGRATION WARNING: Taproot script-path (P2TR with scripts) UTXOs are NOT supported for migration.\n");
        LogPrintf("BCH2 MIGRATION WARNING: Only Taproot key-path spending is supported after the BCH2 fork.\n");
        LogPrintf("BCH2 MIGRATION WARNING: If you have Taproot script-path UTXOs, move them BEFORE the BCH2 fork activates.\n");
