...
#ifndef BITCOINII_UTIL_MESSAGE_H
#define BITCOINII_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's BCH2 address, it must refer to a public key.
...
#endif // BITCOINII_UTIL_MESSAGE_H
