 ...
 *
 * This prevents fingerprinting BCH2 nodes as "claiming witness support
...
enum GetDataMsg : uint32_t {
    ...
    MSG_TX = 1,
    MSG_BLOCK = 2,
    MSG_WTX = 5,                                      //!< Defined in BIP 339. BCH2: After fork, wtxid equals txid.
    ...
    MSG_DOUBLESPENDPROOF = 0x94a0,                    //!< BCH2: Double-spend proof (from BCHN)
};
