      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->bitcoinIIAtStartup->setToolTip(ui->bitcoinIIAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bitcoinIIAtStartup->setText(ui->bitcoinIIAtStartup->text().arg(PACKAGE_NAME));

    ui->openBitcoinIIConfButton->setToolTip(ui->openBitcoinIIConfButton->toolTip().arg(PACKAGE_NAME));
