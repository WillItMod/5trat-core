...
public:
    ...
    QSize minimumSizeHint() const override
    {
        if(cachedMinimumSizeHint.isEmpty())
        {
            ...
            int w = GUIUtil::TextWidth(fm, BitcoinIIUnits::format(BitcoinIIUnit::BCH2, BitcoinIIUnits::maxMoney(), false, BitcoinIIUnits::SeparatorStyle::ALWAYS));
...
private:
    BitcoinIIUnit currentUnit{BitcoinIIUnit::BCH2};
