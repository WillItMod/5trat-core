...
std::string GetOpName(opcodetype opcode)
{
    ...
    // Note: In BTC Tapscript this is OP_CHECKSIGADD, but BCH2 disables Tapscript
...
// and blocks from before the BCH2 fork. New witness outputs cannot be created after fork.
