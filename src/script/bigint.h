...
// NOTE: This file is currently DEAD CODE in the BCH2 build.
...
#ifndef BITCOINII_SCRIPT_BIGINT_H
#define BITCOINII_SCRIPT_BIGINT_H
...
#endif // BITCOINII_SCRIPT_BIGINT_H
